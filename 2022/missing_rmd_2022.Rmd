...
Do we want to use readability to predict the three dichotomous outcomes (e.g., don't know)? Not sure what that would look like - is that most easily understood if we explore 3 unique regressions? 
