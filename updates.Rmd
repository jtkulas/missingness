...
We want to expand this figure by including `quanteda` text analyses (or careless responses)
 
```{r quanteda}

write.csv(together, "letslook.csv")

#library(quanteda)

#temp <- data[-150,]   ## Duplicate item

#data2 <- corpus(temp, docid_field = "Items",
#  text_field = "Items")
